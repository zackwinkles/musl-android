...
CFLAGS_NOSSP = -fno-stack-protector -U_FORTIFY_SOURCE

CFLAGS_ALL = $(CFLAGS_C99FSE)
CFLAGS_ALL += -D_XOPEN_SOURCE=700 -I$(srcdir)/arch/$(ARCH) -I$(srcdir)/arch/generic -Iobj/src/internal -I$(srcdir)/src/include -I$(srcdir)/src/internal -I$(srcdir)/include/fortify -Iobj/include -I$(srcdir)/include
