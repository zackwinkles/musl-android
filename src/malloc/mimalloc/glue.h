...
// ------------------------------------------------------
  ...
  export void* malloc(size_t size)              MI_FORWARD1(mi_malloc, size)
  export void* calloc(size_t size, size_t n)    MI_FORWARD2(mi_calloc, size, n)
  export void* realloc(void* p, size_t newsize) MI_FORWARD2(mi_realloc, p, newsize)
  export void  free(void* p)                    MI_FORWARD0(mi_free, p)

  #define __libc_malloc(s)			mi_malloc(s)
  #define __libc_calloc(s, n)		mi_calloc(s, n)
  #define __libc_realloc(p, s)		mi_realloc(p, s)
  #define __libc_free(p)			mi_free(p)
  ...
  export char* strdup(const char* str)             MI_FORWARD1(mi_strdup, str)
  export char* strndup(const char* str, size_t n)  MI_FORWARD2(mi_strndup, str, n)
#endif
