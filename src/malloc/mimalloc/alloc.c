...
static inline mi_decl_restrict void* mi_heap_malloc_small_zero(mi_heap_t* heap, size_t size, bool zero) {
  mi_assert(heap != NULL);
  #if MI_DEBUG
...
extern inline mi_decl_restrict void* mi_heap_malloc_small(mi_heap_t* heap, size_t size) {
  return mi_heap_malloc_small_zero(heap, size, false);
}

extern inline mi_decl_restrict void* mi_malloc_small(size_t size) {
...
extern inline mi_decl_restrict void* mi_heap_malloc(mi_heap_t* heap, size_t size) {
  return _mi_heap_malloc_zero(heap, size, false);
}

extern inline mi_decl_restrict void* mi_malloc(size_t size) {
  return mi_heap_malloc(mi_prim_get_default_heap(), size);
}

// zero initialized small block
mi_decl_restrict void* mi_zalloc_small(size_t size) {
  return mi_heap_malloc_small_zero(mi_prim_get_default_heap(), size, true);
}

extern inline mi_decl_restrict void* mi_heap_zalloc(mi_heap_t* heap, size_t size) {
  return _mi_heap_malloc_zero(heap, size, true);
}

mi_decl_restrict void* mi_zalloc(size_t size) {
  return mi_heap_zalloc(mi_prim_get_default_heap(),size);
}


extern inline mi_decl_restrict void* mi_heap_calloc(mi_heap_t* heap, size_t count, size_t size) {
  size_t total;
  if (mi_count_size_overflow(count,size,&total)) return NULL;
  return mi_heap_zalloc(heap,total);
}

mi_decl_restrict void* mi_calloc(size_t count, size_t size) {
  return mi_heap_calloc(mi_prim_get_default_heap(),count,size);
}

// Uninitialized `calloc`
extern mi_decl_restrict void* mi_heap_mallocn(mi_heap_t* heap, size_t count, size_t size) {
  size_t total;
  if (mi_count_size_overflow(count, size, &total)) return NULL;
  return mi_heap_malloc(heap, total);
}

mi_decl_restrict void* mi_mallocn(size_t count, size_t size) {
...
mi_decl_restrict char* mi_heap_strdup(mi_heap_t* heap, const char* s) {
...
mi_decl_restrict char* mi_strdup(const char* s) {
  return mi_heap_strdup(mi_prim_get_default_heap(), s);
}

// `strndup` using mi_malloc
mi_decl_restrict char* mi_heap_strndup(mi_heap_t* heap, const char* s, size_t n) {
  if (s == NULL) return NULL;
...
mi_decl_restrict char* mi_strndup(const char* s, size_t n) {
...
#endif
#include <windows.h>
mi_decl_restrict char* mi_heap_realpath(mi_heap_t* heap, const char* fname, char* resolved_name) {
...
mi_decl_restrict char* mi_realpath(const char* fname, char* resolved_name) {
...
export mi_decl_noinline void* mi_heap_try_new(mi_heap_t* heap, size_t size, bool nothrow ) {
  void* p = NULL;
...
mi_decl_restrict void* mi_heap_alloc_new(mi_heap_t* heap, size_t size) {
...
mi_decl_restrict void* mi_heap_alloc_new_n(mi_heap_t* heap, size_t count, size_t size) {
  size_t total;
...
mi_decl_restrict void* mi_new_nothrow(size_t size) {
...
mi_decl_restrict void* mi_new_aligned_nothrow(size_t size, size_t alignment) {
  void* p;
  do {
    p = mi_malloc_aligned(size, alignment);
  }
